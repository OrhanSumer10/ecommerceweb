...
{
    public partial class Ecommorce : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OptionValue = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AdditionalPrice = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AppliedCouponsCouponId = table.Column<int>(type: "int", nullable: false),
                    OrdersOrderId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderCoupons", x => new { x.AppliedCouponsCouponId, x.OrdersOrderId });
                    table.ForeignKey(
                        name: "FK_OrderCoupons_Coupons_AppliedCouponsCouponId",
                        column: x => x.AppliedCouponsCouponId,
                        principalTable: "Coupons",
                        principalColumn: "CouponId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderCoupons_Orders_OrdersOrderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDetails", x => new { x.OrderId, x.ProductId, x.ProductOptionId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderCoupons_OrdersOrderId",
                table: "OrderCoupons",
